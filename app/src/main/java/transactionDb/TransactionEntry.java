...
public class TransactionEntry {
    ...
    @Ignore
    public TransactionEntry(int amount, String category, String description, Date date,
    ...
    public TransactionEntry(int id, int amount, String category, String description, Date date,
    String transactionType) {
        this.id = id;
        this.amount = amount;
        this.category = category;
